...
class UsuariosController {
    ...
    public function login($correo, $contraseña) {
        ...
        // Retornar con rol y ruta sugerida (opcional para el frontend)
        return [
                'success' => true,
                'rol' => $usuario['rol'],
                'redirect' => ($usuario['rol'] === 'admin') ? '/PF_D Julia/Administrador/catalogo/catalogo.html' : '/PF_D Julia/Cliente/prueba.html'
        ];
    }
    //Cerrar Sesión
